                                ...
                                <ul>
                                  <li class="">
                                   ...
                                   <?php 
                                    ...
                                    <?php endwhile; ?>
                                    <li>
                                        <a class="active main-menu-link" href="about-us.php">About Us</a>
                                    </li>
                                    <li>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="about-promo-single-item">
                        ...
                        <h6>Best Shopping Websites</h6>
                        <p>ApnaDeal provides access to new markets with a fast, low-cost, low-wastage, highly-reliable shipping & delivery system across India for its buyers and sellers. Apnadeal Capital, the NBFC arm focused on SME financing service, provides financial products for sellers and buyers to grow their business</p>
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="about-promo-single-item">
                        ...
                        <h6>21 Days Return Gaurantee</h6>
                        <p> Return a product only if the product is cut or torn or the wrong product has been delivered, otherwise do not return the product.  
                        Please talk to our customer service before returning.</p>
                    </div> <!-- End About Promo Single Item -->
                </div>
                <div class="col-lg-4 col-md-6">
                    <!-- Start About Promo Single Item -->
